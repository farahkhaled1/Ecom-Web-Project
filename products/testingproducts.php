...
<body>
  ...
  <form class="d-flex">
    <input style="width: 20%;" class="form-control me-2" type="search" placeholder="Search" aria-label="Search" name="search" value="<?php if (isset($_GET['search'])) {
                                                                                                                                        echo $_GET['search'];
                                                                                                                                      } ?>">
  ...
  <h1>All Products</h1>
  <?php
  $conn = new mysqli("localhost", "root", "", "glowglam");
